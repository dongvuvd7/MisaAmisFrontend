    ...
    <div class="dialog" :class="{'dialog_hide': !isShow}">
        ...
        <div class="dialog-content">
                <div class="header">
                    ...
                    <div style="">Bạn có thực sự muốn xóa Nhân viên <b>&#60;<span>{{ncc.nccCode}}</span>&#62;</b> không?</div>
                </div>
                <div class="footer">
...
export default {
    ...
    methods: {
        ...
        btnDelete() {
            ...
            axios
                .delete(getBankNcc + this.ncc.nccId) //xóa ngân hàng liên kết
                .then(() => {
                    axios
                        .delete(getAll + this.ncc.nccId) //xóa ncc
                        .then(() => {
